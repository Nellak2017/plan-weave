...
import { addTaskThunkAPI, completeTaskThunkAPI, editTaskNameThunkAPI, editTtcThunkAPI } from './entities/tasks/tasksThunks.js'
...
export { searchThunk, sortThunk, checkTimeRangeThunk, toggleThunk, updateTimeRangeThunk, updateMultiDeleteFSMThunk,
    ...
    addTaskThunkAPI, completeTaskThunkAPI, editTaskNameThunkAPI, editTtcThunkAPI,
 }
