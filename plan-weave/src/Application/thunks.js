...
import { addTaskThunkAPI, completeTaskThunkAPI, editTaskNameThunkAPI } from './entities/tasks/tasksThunks.js'
...
export { searchThunk, sortThunk, checkTimeRangeThunk, toggleThunk, updateTimeRangeThunk, updateMultiDeleteFSMThunk,
    ...
    addTaskThunkAPI, completeTaskThunkAPI, editTaskNameThunkAPI
 }
