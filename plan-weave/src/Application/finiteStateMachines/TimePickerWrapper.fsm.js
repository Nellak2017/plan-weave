...
// --- Getters
export const getFSMTransition = (state, event, fsm = TimePickerFSM) => fsm?.states?.[state]?.transitions?.[event] || DEFAULT
export const getFSMValue = (state, value, fsm = TimePickerFSM) => fsm?.states?.[state]?.[value] // no default value other than undefined
export const getDefaultState = (fsm = TimePickerFSM) => fsm?.initial
// --- Handlers
