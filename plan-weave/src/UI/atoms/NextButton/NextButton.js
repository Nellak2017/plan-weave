...
const letterToSize = (sizeChar = 'l') => calculateSize({ 'xs': theme.spaces.smaller, 's': theme.spaces.small, 'm': theme.spaces.medium,  'l': theme.spaces.large,  'xl': theme.spaces.larger, 'xxl': theme.spaces.extraLarge,}[sizeChar] || '32px')
