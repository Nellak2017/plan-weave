...
export const OptionPicker = ({
	state: { options = [], label = 'Select Predecessors', multiple = true } = {},
	...
	<Autocomplete
		...
		renderOption={(props, option, { selected }) => (<StyledOption selected={selected} {...props} >{option.label || option}</StyledOption>)}
