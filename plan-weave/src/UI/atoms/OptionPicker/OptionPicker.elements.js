...
export const StyledChip = styled(Chip)(({ theme }) => ({ backgroundColor: theme.palette.background.paper, span: { color: theme.palette.text.primary, }, 'svg:hover > path': { color: theme.palette.error.main, }, }))
