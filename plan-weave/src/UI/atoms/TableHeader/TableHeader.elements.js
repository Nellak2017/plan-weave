...
const tableHeaderPresets = ({ theme, variant }) => ({
	light: variantStyles({ bg: theme.palette.lightNeutral[50], color: theme.palette.grey[600] }),
	dark: variantStyles({ bg: theme.palette.lightNeutral[300], color: theme.palette.lightNeutral[50] }),
}?.[variant])
