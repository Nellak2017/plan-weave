...
const DeleteModal = ({ state, services }) => {
	...
	const { deleteMany = (_, __) => console.warn('deleteMany not implemented for DeleteModal'), highlighting = () => console.warn('highlighting not implemented for DeleteModal'), setIsDeleteClicked = (_) => console.warn('setIsDeleteClicked not implemented for DeleteModal'), closeToast = () => console.warn('closeToast not implemented for DeleteModal') } = services || {}
	return (
