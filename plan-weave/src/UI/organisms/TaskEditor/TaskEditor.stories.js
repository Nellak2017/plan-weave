...
const TaskEditorStories = {
	...
	argTypes: { variant: { control: 'text' }, maxwidth: { control: 'number' }, sortingAlgorithm: { control: 'text' }, useReduxData: { control: 'boolean' },},
}
const Template = args => <Provider store={store}><TaskEditor {...args} /></Provider>
const options = [
...
Light.args = { variant: 'light', sortingAlgorithm: '', options}
export const Dark = Template.bind({})
Dark.args = { variant: 'dark', sortingAlgorithm: 'timestamp', options}
