...
const initialState = {
	...
	*/
	tasks: [
		{ status: 'incomplete', task: 'Breakfast', ttc: .5, id: 1, timestamp: timestamp }, 
		{ status: 'incomplete', task: 'Gym', ttc: 1.5, id: 2, timestamp: timestamp - 1 }, 
		{ status: 'incomplete', task: 'Shower+', ttc: .5, id: 3, timestamp: timestamp - 2 },
		{ status: 'incomplete', task: 'SE II - Quiz, Study, Asher', ttc: 1.5, id: 4, timestamp: timestamp - 3 },
		{ status: 'incomplete', task: 'Cyber Sec Study', ttc: .75, id: 5, timestamp: timestamp - 4 },
		{ status: 'incomplete', task: 'Small Git', ttc: .75, id: 6, timestamp: timestamp - 5 },
		...
		{ status: 'incomplete', task: 'Ethics Lib (1/3)', ttc: 1, id: 10, timestamp: timestamp - 10 },
		{ status: 'incomplete', task: 'Break', ttc: .75, id: 11, timestamp: timestamp - 11 },
		...
		{ status: 'incomplete', task: 'COD', ttc: 2, id: 17, timestamp: timestamp - 17 },
		{ status: 'incomplete', task: 'FP book study', ttc: 1, id: 18, timestamp: timestamp - 18 },
	]
}
