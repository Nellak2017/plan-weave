...
const initialState = {
	tasks: [
		{ status: 'incomplete', task: 'Cyber - Study, Quiz Prep, W5, Other', ttc: 3, id: 1, timestamp: timestamp }, 
		{ status: 'incomplete', task: 'Gym', ttc: 1.5, id: 2, timestamp: timestamp - 1 }, 
		{ status: 'incomplete', task: 'Shower / Meal prep / Eat', ttc: 1, id: 3, timestamp: timestamp - 2 },
		{ status: 'incomplete', task: 'ML - A4, Study', ttc: 1.5, id: 4, timestamp: timestamp - 3 },
		{ status: 'incomplete', task: 'break', ttc: .5, id: 5, timestamp: timestamp - 4 },
		{ status: 'incomplete', task: 'Span - Mindtap, Disc, Study', ttc: 2, id: 6, timestamp: timestamp - 5 },
		...
		{ status: 'incomplete', task: 'break', ttc: 1, id: 10, timestamp: timestamp - 10 },
		/*
