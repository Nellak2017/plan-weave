...
const initialState = {
	...
	*/
	tasks: [
		...
		{ status: 'incomplete', task: 'Ethics - Quiz 2', ttc: 2, id: 3, timestamp: timestamp - 2 },
		{ status: 'incomplete', task: 'Spanish - Ch P, Study, Duo', ttc: 2, id: 4, timestamp: timestamp - 3 },
		{ status: 'incomplete', task: 'Gym', ttc: 1.5, id: 5, timestamp: timestamp - 4 },
		{ status: 'incomplete', task: 'Shower +', ttc: .5, id: 6, timestamp: timestamp - 5 },
		{ status: 'incomplete', task: 'Lunch', ttc: .75, id: 7, timestamp: timestamp - 6 },
		{ status: 'incomplete', task: 'Cyber Security - Ch 1-3, Linux review', ttc: 1, id: 8, timestamp: timestamp - 8 },
