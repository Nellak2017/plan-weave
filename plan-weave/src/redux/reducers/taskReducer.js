...
const initialState = {
	tasks: [
		...
		{ status: 'incomplete', task: 'break', ttc: .5, id: 2, timestamp: timestamp - 1 }, 
		{ status: 'incomplete', task: 'Clean', ttc: .5, id: 3, timestamp: timestamp - 2 },
		{ status: 'incomplete', task: 'Stir-fry Meal Prep', ttc: 1, id: 4, timestamp: timestamp - 3 },
		{ status: 'incomplete', task: 'Lunch', ttc: .25, id: 5, timestamp: timestamp - 4 },
		{ status: 'incomplete', task: 'Span - study, mindtap, disc', ttc: 2, id: 6, timestamp: timestamp - 5 },
