...
const initialState = {
	tasks: [
		{ status: 'incomplete', task: 'break', ttc: .75, id: 1, timestamp: timestamp }, 
		{ status: 'incomplete', task: 'Span - study, mindtap, disc', ttc: 1.5, id: 2, timestamp: timestamp - 1 }, 
		...
		{ status: 'incomplete', task: 'Clean', ttc: .5, id: 5, timestamp: timestamp - 4 },
		{ status: 'incomplete', task: 'Cyber - text 2-5, fl, a2, slide, lect.', ttc: 2, id: 6, timestamp: timestamp - 5 },
		{ status: 'incomplete', task: 'break', ttc: .5, id: 7, timestamp: timestamp - 6 },
		{ status: 'incomplete', task: 'SE II - Study, Lectures, Project', ttc: 1, id: 9, timestamp: timestamp - 9 },
		{ status: 'incomplete', task: 'break', ttc: .75, id: 10, timestamp: timestamp - 10 },
		{ status: 'incomplete', task: 'ML - A4, Study', ttc: 1.5, id: 11, timestamp: timestamp - 11 },
		/*
