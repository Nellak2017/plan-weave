...
const initialState = {
	...
	*/
	tasks: [
		{ status: 'incomplete', task: 'Span - Mindtap, Disc, Study', ttc: 4, id: 1, timestamp: timestamp }, 
		{ status: 'incomplete', task: 'Ethics - P2', ttc: 1.5, id: 2, timestamp: timestamp - 1 }, 
		{ status: 'incomplete', task: 'break', ttc: 2, id: 3, timestamp: timestamp - 2 },
		{ status: 'incomplete', task: 'ML - A4, Study', ttc: .75, id: 4, timestamp: timestamp - 3 },
		...
		{ status: 'incomplete', task: 'Driving', ttc: .75, id: 9, timestamp: timestamp - 9 },
		/*
		{ status: 'incomplete', task: '', ttc: 1.75, id: 10, timestamp: timestamp - 10 },
