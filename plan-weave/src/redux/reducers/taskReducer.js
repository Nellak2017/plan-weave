...
const initialState = {
	...
	*/
	tasks: [
		{ status: 'incomplete', task: 'Breakfast + Small Git', ttc: 1, id: 1, timestamp: timestamp }, // waste = 2 hours 7 minutes
		{ status: 'incomplete', task: 'Spanish Exam 1', ttc: .5, id: 2, timestamp: timestamp - 1 }, // waste = 42 minutes
		{ status: 'incomplete', task: 'Therapy', ttc: 1, id: 3, timestamp: timestamp - 2 },
		{ status: 'incomplete', task: 'Break', ttc: .75, id: 4, timestamp: timestamp - 3 },
		{ status: 'incomplete', task: 'A3 ML', ttc: 1.5, id: 5, timestamp: timestamp - 4 },
		{ status: 'incomplete', task: 'Gym', ttc: 1.25, id: 6, timestamp: timestamp - 5 },
		{ status: 'incomplete', task: 'Shower + Shave', ttc: .5, id: 7, timestamp: timestamp - 6 },
		{ status: 'incomplete', task: 'Clean', ttc: .75, id: 9, timestamp: timestamp - 9 },
		{ status: 'incomplete', task: 'Lunch', ttc: 1, id: 10, timestamp: timestamp - 10 },
		{ status: 'incomplete', task: 'Study FP JS Book', ttc: 1, id: 11, timestamp: timestamp - 11 },
		{ status: 'incomplete', task: 'Break', ttc: .75, id: 12, timestamp: timestamp - 12 },
		{ status: 'incomplete', task: 'Driving', ttc: 1, id: 13, timestamp: timestamp - 13 },
		{ status: 'incomplete', task: 'COD', ttc: 2, id: 14, timestamp: timestamp - 14 },
