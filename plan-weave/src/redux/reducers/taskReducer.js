...
const initialState = {
	tasks: [
		{ status: 'incomplete', task: 'break', ttc: .5, id: 1, timestamp: timestamp }, 
		{ status: 'incomplete', task: 'Lunch', ttc: .5, id: 2, timestamp: timestamp - 1 }, 
		{ status: 'incomplete', task: 'Span: Study, Mindtap, Discussion, (28-Sep, 12.5%)', ttc: .5, id: 3, timestamp: timestamp - 2 },
		{ status: 'incomplete', task: 'Cyber: Text 2-5, Slides, Flash, Lectures 3x, A2', ttc: 1, id: 4, timestamp: timestamp - 3 },
		{ status: 'incomplete', task: 'ML: Study, A5 (29-Sep, 1.875%)', ttc: .25, id: 5, timestamp: timestamp - 4 },
		{ status: 'incomplete', task: 'SE II:  Review Lecture, Study, A2 (29-Sep, 1.25%)', ttc: 2, id: 6, timestamp: timestamp - 5 },
		{ status: 'incomplete', task: 'Shower +', ttc: .5, id: 7, timestamp: timestamp - 6 },
		/*
