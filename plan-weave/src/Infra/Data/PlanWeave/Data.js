...
export const defaultLogout = ({ text = 'Log Out', link = '/', title = 'Log Out', label = 'Log Out of Plan-Weave', handler = handleLogout, index = 4 }) => (makeLink({ text, link, title, label, handler, index }))